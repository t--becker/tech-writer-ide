...
import TrelloView from './views/trello-view';
import { CompositeDisposable } from 'atom';
import actions from './actions';
import validator from './utils/validate-markdown';

TrelloClient = require('./client/trello-client.js');
...
############################################################################
*/
    this.trelloView = new TrelloView(state.TrelloViewState);
    ...
    //global
    controller = new Controller(this.modalPanel, this.rightPanel, this.markdownPanel, this.markdownPreviewView, this.trelloView, this.techWriterIDEView);
    TC = new TrelloClient('key','token');
